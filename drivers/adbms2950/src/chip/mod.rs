...
//! chip's registers and commands, mostly taken straight from the datasheet and encoded into Rust. The full ADBMS2950B driver can use this interface to interact with registers
